...
class LaptopPage extends BasePage {
    ...
    clickManufacturerFilterCheckBox(value) {
        this.filterCheckBoxForCategory(MANUFACTURER_LABEL, value).click({ force: true });
    };
    clickYearCheckbox(value) {
        this.filterCheckBoxForCategory(RELEASE_YEAR_LABEL, value).click({ force: true });
    };
    clickScreenDiagonalCheckbox(value) {
        this.filterCheckBoxForCategory(SCREEN_SIZE_LABEL, value).click({ force: true });
    };
